...
let
tlv8 = pkgs.callPackage ../../modules/packages/tlv8_python.nix { inherit lib buildPythonPackage fetchPypi; };
fnvhash = pkgs.callPackage ../../modules/packages/fnvhash_python.nix { inherit lib buildPythonPackage fetchPypi; };
in
